...
Entry: `.bozzetto/design/bozzetto-hello/page.tsx` exports `mount(container)` for client-side rendering. `.bozzetto/config.ts` declares `staticCss({ files: ["app/globals.css"] })`.
